...
const SUBJECT_ADMIN = "Nova rezervacija – Parking Aerodrom Sarajevo";
const SUBJECT_GUEST = "Potvrda rezervacije – Parking Aerodrom Sarajevo";
...
`.trim();
    ...
    await transporter.sendMail({
      from: `"Parking Aerodrom Sarajevo" <${user}>`,
      to: adminEmail,
...
<p>Poštovani ${ime},</p>
<p>Vaša rezervacija parkinga je uspješno zaprimljena.</p>
<ul>
