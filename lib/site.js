...
const GOOGLE_MAP_QUERY =
  "mPark | Privatni Parking Aerodrom Sarajevo";
...
export const SITE = {
  ...
  /** Viber chat — isti broj kao telefon/WhatsApp (vb.me radi na mobilnom i desktopu). */
  viberUrl: "viber://chat?number=38761512152",
  ...
  geo: BUSINESS_GEO,
  googleMapsEmbedUrl: `https://www.google.com/maps?ll=${BUSINESS_GEO.latitude},${BUSINESS_GEO.longitude}&z=18&q=${encodeURIComponent(GOOGLE_MAP_QUERY)}&output=embed`,
  googleProfileUrl:
    process.env.NEXT_PUBLIC_GOOGLE_PROFILE_URL?.trim() ||
    "https://www.google.com/maps?cid=5316496838324807226",
  seoKeywords: [
...
export const HERO_IMAGE = "/images/hero-parking.webp";
