/** Primarni (kanonski) javni origin — apex (bez www), jedna verzija u indeksu. */
const CANONICAL_ORIGIN = "https://mpark-sarajevo.com";
...
function normalizePublicSiteUrl(input) {
  ...
  try {
    ...
    // Apex i www → uvijek https://mpark-sarajevo.com
