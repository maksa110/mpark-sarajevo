/** Primarni (kanonski) javni origin — www (usklađeno s uobičajenim Vercel „primary“ domenom). */
...
function normalizePublicSiteUrl(input) {
  ...
  try {
    ...
    // Apex i www → uvijek https://www... (jedan host u meta/sitemap — izbjegava redirect petlju s Vercel Domain.)
