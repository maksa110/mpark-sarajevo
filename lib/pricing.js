// Single source of truth for parking pricing tiers (1–9 / 10–14 / 15+ days).
// Mirrors UI in components/PricingSection.jsx and JSON-LD in app/[locale]/page.jsx.

export const PRICE_TIERS = [
  { tier: "t1", minDays: 1, maxDays: 9, rate: 9 },
  { tier: "t2", minDays: 10, maxDays: 14, rate: 8 },
  { tier: "t3", minDays: 15, maxDays: Infinity, rate: 7 },
];
